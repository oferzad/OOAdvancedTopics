...
namespace OOAdvancedTopics
{
    ...
    class MonkeyList
    {
        ...
        public delegate bool SearchFunc(Monkey m);
        public delegate bool SearchFunc<T>(T obj);
        public bool SearchMonkeys(SearchFunc<Monkey> func)
        {
        ...
        {
            return SearchMonkeys((m) => m.Name == name);
        }

        public bool SearchByName2(string name)
        {
            Monkey? m = Monkeys.Find(m => m.Name == name);
            return m != null;
        }
